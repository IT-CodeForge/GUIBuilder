...
class GUI(ETKMainWindow):
    ...
    def _add_elements(self):
        ...
        self.main = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize.from_vector2d(
            self.size), offset=0)

        self.menubar_outer = ETKContainer(self._main, size=ETKBaseContainer.ContainerSize(
        ...
        self.menubar_left = ETKListingContainer(self._main, Vector2d(0, 0), ETKBaseContainer.ContainerSize(0, self.MENUBAR_HEIGHT, True, False, self.MENUBAR_PADDING, self.MENUBAR_PADDING), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, alignment=ETKBaseContainer.ALIGNMENTS.MIDDLE_CENTER, offset=self.MENUBAR_PADDING, outline_thickness=2)
        self.menubar_inner.add_element(self.menubar_left)

        self.menubar_right = ETKListingContainer(self._main, Vector2d(0, 0), ETKBaseContainer.ContainerSize(0, self.MENUBAR_HEIGHT, True, False, self.MENUBAR_PADDING, self.MENUBAR_PADDING), listing_type=ETKListingContainer.LISTING_TYPES.RIGHT_TO_LEFT, alignment=ETKBaseContainer.ALIGNMENTS.MIDDLE_CENTER, offset=self.MENUBAR_PADDING, outline_thickness=2)
        self.menubar_inner.add_element(
            self.menubar_right, ETKBaseContainer.ALIGNMENTS.TOP_RIGHT)

        self.main2 = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(
            self.size.x, self.size.y-self.menubar_outer.size.y), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=0)
        self.main.add_element(self.main2)

        self.attributes = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(
            self.ATTRIBUTES_WIDTH, self.main2.size.y), offset=0)
        self.main2.add_element(self.attributes)

        self.attributes_element = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(
        ...
        self.attributes_window = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(
        ...
        self.element_area = ETKContainer(
            self._main, size=ETKBaseContainer.ContainerSize(500, 500), outline_thickness=2)
        self.main2.add_element(self.element_area)
        self.element_area.add_event(ETKContainer.EVENTS.MOUSE_DOWN, self.__element_area_mousedown_handler)
        ...
        self.menubar_button.add_event(
            ETKButton.EVENTS.MOUSE_DOWN, self.__menubar_left_handler)
        ...
        self.menubar_label.add_event(
            ETKLabel.EVENTS.MOUSE_DOWN, self.__menubar_left_handler)
        ...
        self.menubar_checkbox.add_event(
            ETKCheckbox.EVENTS.MOUSE_DOWN, self.__menubar_left_handler)
        ...
        self.attributes_element_title_container = ETKContainer(self._main, size=ETKBaseContainer.ContainerSize(
        ...
        self.attributes_element_inner = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(
        ...
        self.attributes_element_delete.add_event(ETKButton.EVENTS.PRESSED, self.__delete_element_event)

        self.attributes_element_id_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=0)
        ...
        self.attributes_element_name_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_element_name_var_1 = ETKLabel(self._main, text="", size=Vector2d(30, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        self.attributes_element_name_container.add_element(self.attributes_element_name_var_1)
        self.attributes_element_name_var_2 = ETKEdit(self._main, text="", size=Vector2d(200, self.ATTRIBUTES_ELEMENT_HEIGHT))
        self.attributes_element_name_container.add_element(self.attributes_element_name_var_2)
        self.attributes_element_inner.add_element(self.attributes_element_name_container)
        self.attributes_element_name_var_2.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__element_attribut_changed_handler)

        self.attributes_element_text_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_element_text_var.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__element_attribut_changed_handler)

        self.attributes_element_pos_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_element_pos_var_x.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__element_attribut_changed_handler)
        self.attributes_element_pos_var_y.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__element_attribut_changed_handler)

        self.attributes_element_size_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_element_size_var_x.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__element_attribut_changed_handler)
        self.attributes_element_size_var_y.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__element_attribut_changed_handler)

        self.attributes_element_text_color_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_element_text_color_var_r.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__element_attribut_changed_handler)
        self.attributes_element_text_color_var_g.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__element_attribut_changed_handler)
        self.attributes_element_text_color_var_b.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__element_attribut_changed_handler)

        self.attributes_element_background_color_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_element_background_color_var_r.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__element_attribut_changed_handler)
        self.attributes_element_background_color_var_g.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__element_attribut_changed_handler)
        ...
        self.attributes_element_interval_var.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__element_attribut_changed_handler)

        self.attributes_element_enabled_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_element_enabled_var.add_event(ETKCheckbox.EVENTS.TOGGLED, self.__element_attribut_changed_handler)

        self.attributes_element_checked_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_element_checked_var.add_event(ETKCheckbox.EVENTS.TOGGLED, self.__element_attribut_changed_handler)

        self.attributes_element_multiple_lines_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_element_multiple_lines_var.add_event(ETKCheckbox.EVENTS.TOGGLED, self.__element_attribut_changed_handler)

        self.attributes_element_spacing_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 30, True, False), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_element_event_pressed_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_element_event_pressed_var.add_event(ETKCheckbox.EVENTS.TOGGLED, self.__element_attribut_changed_handler)

        self.attributes_element_event_double_pressed_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_element_event_double_pressed_var.add_event(ETKCheckbox.EVENTS.TOGGLED, self.__element_attribut_changed_handler)

        self.attributes_element_event_changed_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_element_event_changed_var.add_event(ETKCheckbox.EVENTS.TOGGLED, self.__element_attribut_changed_handler)

        self.attributes_element_event_hovered_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_element_event_hovered_var.add_event(ETKCheckbox.EVENTS.TOGGLED, self.__element_attribut_changed_handler)

        # endregion
        # region attributes_window Elemente

        self.attributes_window_title_container = ETKContainer(self._main, size=ETKBaseContainer.ContainerSize(
        ...
        self.attributes_window_name_var_1 = ETKLabel(self._main, text="e0_", size=Vector2d(27, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        self.attributes_window_name_container.add_element(self.attributes_window_name_var_1)
        self.attributes_window_name_var_2 = ETKEdit(self._main, text="", size=Vector2d(200, self.ATTRIBUTES_ELEMENT_HEIGHT))
        self.attributes_window_name_container.add_element(self.attributes_window_name_var_2)
        self.attributes_window.add_element(self.attributes_window_name_container)
        self.attributes_window_name_var_2.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__window_attribut_changed_handler)

        self.attributes_window_title_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_window_title_var.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__window_attribut_changed_handler)

        self.attributes_window_size_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_window_size_var_x.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__window_attribut_changed_handler)
        self.attributes_window_size_var_y.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__window_attribut_changed_handler)

        self.attributes_window_title_color_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_window_title_color_var_r.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__window_attribut_changed_handler)
        self.attributes_window_title_color_var_g.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__window_attribut_changed_handler)
        self.attributes_window_title_color_var_b.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__window_attribut_changed_handler)

        self.attributes_window_background_color_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_window_background_color_var_r.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__window_attribut_changed_handler)
        self.attributes_window_background_color_var_g.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__window_attribut_changed_handler)
        self.attributes_window_background_color_var_b.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__window_attribut_changed_handler)

        self.attributes_window_spacing_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 30, True, False), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_window_event_create_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_window_event_create_var.add_event(ETKCheckbox.EVENTS.TOGGLED, self.__window_attribut_changed_handler)

        self.attributes_window_event_destroy_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_window_event_destroy_var.add_event(ETKCheckbox.EVENTS.TOGGLED, self.__window_attribut_changed_handler)

        self.attributes_window_event_paint_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_window_event_paint_var.add_event(ETKCheckbox.EVENTS.TOGGLED, self.__window_attribut_changed_handler)

        self.attributes_window_event_resize_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_window_event_resize_var.add_event(ETKCheckbox.EVENTS.TOGGLED, self.__window_attribut_changed_handler)

        self.attributes_window_event_mouse_click_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_window_event_mouse_click_var.add_event(ETKCheckbox.EVENTS.TOGGLED, self.__window_attribut_changed_handler)

        self.attributes_window_event_mouse_move_container = ETKListingContainer(self._main, size=ETKBaseContainer.ContainerSize(0, 0, True, True), listing_type=ETKListingContainer.LISTING_TYPES.LEFT_TO_RIGHT, offset=3)
        ...
        self.attributes_window_event_mouse_move_var.add_event(ETKCheckbox.EVENTS.TOGGLED, self.__window_attribut_changed_handler)
    ...
    def create_new_element(self, typ: Type[ETKBaseTkWidgetText]) -> ETKBaseTkWidgetText:
        ...
        new_element.add_event(ETKBaseObject.EVENTS.MOUSE_DOWN, self.__element_mouse_down_handler)
