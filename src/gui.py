...
class GUI(ETKMainWindow):
    ...
    def _add_elements(self):
        ...
        self.attributes_element_name_var.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__element_attribut_changed_handler)
        ...
        self.attributes_window_name_var.add_event(ETKEdit.EVENTS.CHANGED_DELAYED, self.__window_attribut_changed_handler)
