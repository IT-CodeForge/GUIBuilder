...
class GUI(ETKMainWindow):
    ...
    def _add_elements(self):
        ...
        self.menubar_export = ETKButton(
            self._tk_object, text="Export", size=Vector2d(50, self.MENUBAR_ELEMENT_HEIGHT))
        ...
        self.menubar_save = ETKButton(
            self._tk_object, text="Save", size=Vector2d(50, self.MENUBAR_ELEMENT_HEIGHT))
        ...
        self.menubar_load = ETKButton(
            self._tk_object, text="Load", size=Vector2d(50, self.MENUBAR_ELEMENT_HEIGHT))
        ...
        self.language_selector = ETKDropdownMenu(
            self._tk_object, options=self.LANGUAGES, start_value=self.LANGUAGES[0], size=Vector2d(130, self.MENUBAR_ELEMENT_HEIGHT))
        ...
        self.attributes_element_title = ETKLabel(self._tk_object, text="Element-Eigenschaften:", size=Vector2d(
        ...
        self.attributes_element_delete = ETKButton(self._tk_object, text="Delete", size=Vector2d(50, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=0xFF0000, text_color=0xFFFFFF)
        ...
        self.attributes_element_id_const = ETKLabel(self._tk_object, text="ID: ", size=Vector2d(30, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        self.attributes_element_id_container.add_element(self.attributes_element_id_const)
        self.attributes_element_id_var = ETKLabel(self._tk_object, text="-", background_color=self.attributes_element.background_color)
        ...
        self.attributes_element_name_const = ETKLabel(self._tk_object, text="Name: ", size=Vector2d(45, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        self.attributes_element_name_container.add_element(self.attributes_element_name_const)
        self.attributes_element_name_var = ETKEdit(self._tk_object, text="-", size=Vector2d(200, self.ATTRIBUTES_ELEMENT_HEIGHT))
        ...
        self.attributes_element_text_const = ETKLabel(self._tk_object, text="Text: ", size=Vector2d(45, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        self.attributes_element_text_container.add_element(self.attributes_element_text_const)
        self.attributes_element_text_var = ETKEdit(self._tk_object, text="-", size=Vector2d(200, self.ATTRIBUTES_ELEMENT_HEIGHT))
        ...
        self.attributes_element_pos_const = ETKLabel(self._tk_object, text="Pos: ", size=Vector2d(45, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        self.attributes_element_pos_container.add_element(self.attributes_element_pos_const)
        self.attributes_element_pos_var_x = ETKEdit(self._tk_object, text="-", size=Vector2d(70, self.ATTRIBUTES_ELEMENT_HEIGHT))
        self.attributes_element_pos_container.add_element(self.attributes_element_pos_var_x)
        self.attributes_element_pos_var_y = ETKEdit(self._tk_object, text="-", size=Vector2d(70, self.ATTRIBUTES_ELEMENT_HEIGHT))
        ...
        self.attributes_element_size_const = ETKLabel(self._tk_object, text="Size: ", size=Vector2d(45, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        self.attributes_element_size_container.add_element(self.attributes_element_size_const)
        self.attributes_element_size_var_x = ETKEdit(self._tk_object, text="-", size=Vector2d(70, self.ATTRIBUTES_ELEMENT_HEIGHT))
        self.attributes_element_size_container.add_element(self.attributes_element_size_var_x)
        self.attributes_element_size_var_y = ETKEdit(self._tk_object, text="-", size=Vector2d(70, self.ATTRIBUTES_ELEMENT_HEIGHT))
        ...
        self.attributes_element_text_color_const = ETKLabel(self._tk_object, text="Text-Color (RGB 24bit): ", size=Vector2d(190, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        self.attributes_element_text_color_container.add_element(self.attributes_element_text_color_const)
        self.attributes_element_text_color_var_r = ETKEdit(self._tk_object, text="-", size=Vector2d(50, self.ATTRIBUTES_ELEMENT_HEIGHT))
        self.attributes_element_text_color_container.add_element(self.attributes_element_text_color_var_r)
        self.attributes_element_text_color_var_g = ETKEdit(self._tk_object, text="-", size=Vector2d(50, self.ATTRIBUTES_ELEMENT_HEIGHT))
        self.attributes_element_text_color_container.add_element(self.attributes_element_text_color_var_g)
        self.attributes_element_text_color_var_b = ETKEdit(self._tk_object, text="-", size=Vector2d(50, self.ATTRIBUTES_ELEMENT_HEIGHT))
        ...
        self.attributes_element_background_color_const = ETKLabel(self._tk_object, text="BG-Color (RGB 24bit): ", size=Vector2d(190, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        self.attributes_element_background_color_container.add_element(self.attributes_element_background_color_const)
        self.attributes_element_background_color_var_r = ETKEdit(self._tk_object, text="-", size=Vector2d(50, self.ATTRIBUTES_ELEMENT_HEIGHT))
        self.attributes_element_background_color_container.add_element(self.attributes_element_background_color_var_r)
        self.attributes_element_background_color_var_g = ETKEdit(self._tk_object, text="-", size=Vector2d(50, self.ATTRIBUTES_ELEMENT_HEIGHT))
        self.attributes_element_background_color_container.add_element(self.attributes_element_background_color_var_g)
        self.attributes_element_background_color_var_b = ETKEdit(self._tk_object, text="-", size=Vector2d(50, self.ATTRIBUTES_ELEMENT_HEIGHT))
        ...
        self.attributes_element_interval_const = ETKLabel(self._tk_object, text="Interval: ", size=Vector2d(75, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        self.attributes_element_interval_container.add_element(self.attributes_element_interval_const)
        self.attributes_element_interval_var = ETKEdit(self._tk_object, text="-", size=Vector2d(50, self.ATTRIBUTES_ELEMENT_HEIGHT))
        ...
        self.attributes_element_enabled_const = ETKLabel(self._tk_object, text="Enabled: ", size=Vector2d(67, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        self.attributes_element_enabled_container.add_element(self.attributes_element_enabled_const)
        self.attributes_element_enabled_var = ETKCheckbox(self._tk_object, text="", size=Vector2d(17, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        ...
        self.attributes_element_checked_const = ETKLabel(self._tk_object, text="Checked: ", size=Vector2d(67, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        self.attributes_element_checked_container.add_element(self.attributes_element_checked_const)
        self.attributes_element_checked_var = ETKCheckbox(self._tk_object, text="", size=Vector2d(17, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        ...
        self.attributes_element_multiple_lines_const = ETKLabel(self._tk_object, text="Multiline: ", size=Vector2d(83, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        self.attributes_element_multiple_lines_container.add_element(self.attributes_element_multiple_lines_const)
        self.attributes_element_multiple_lines_var = ETKCheckbox(self._tk_object, text="", size=Vector2d(17, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        ...
        self.attributes_element_event_title = ETKLabel(self._tk_object, text="Events:", size=Vector2d(
            180, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        ...
        self.attributes_element_event_pressed_const = ETKLabel(self._tk_object, text="Event pressed: ", size=Vector2d(120, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        self.attributes_element_event_pressed_container.add_element(self.attributes_element_event_pressed_const)
        self.attributes_element_event_pressed_var = ETKCheckbox(self._tk_object, text="", size=Vector2d(17, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        ...
        self.attributes_element_event_double_pressed_const = ETKLabel(self._tk_object, text="Event double pressed: ", size=Vector2d(170, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        self.attributes_element_event_double_pressed_container.add_element(self.attributes_element_event_double_pressed_const)
        self.attributes_element_event_double_pressed_var = ETKCheckbox(self._tk_object, text="", size=Vector2d(17, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        ...
        self.attributes_element_event_changed_const = ETKLabel(self._tk_object, text="Event changed: ", size=Vector2d(120, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        self.attributes_element_event_changed_container.add_element(self.attributes_element_event_changed_const)
        self.attributes_element_event_changed_var = ETKCheckbox(self._tk_object, text="", size=Vector2d(17, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        ...
        self.attributes_element_event_hovered_const = ETKLabel(self._tk_object, text="Event hovered: ", size=Vector2d(120, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        self.attributes_element_event_hovered_container.add_element(self.attributes_element_event_hovered_const)
        self.attributes_element_event_hovered_var = ETKCheckbox(self._tk_object, text="", size=Vector2d(17, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_element.background_color)
        ...
        self.attributes_window_title = ETKLabel(self._tk_object, text="Fenster-Eigenschaften:", size=Vector2d(
        ...
        self.attributes_window_id_const = ETKLabel(self._tk_object, text="ID: ", size=Vector2d(30, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_window.background_color)
        self.attributes_window_id_container.add_element(self.attributes_window_id_const)
        self.attributes_window_id_var = ETKLabel(self._tk_object, text="-", background_color=self.attributes_window.background_color)
        ...
        self.attributes_window_name_const = ETKLabel(self._tk_object, text="Name: ", size=Vector2d(45, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_window.background_color)
        self.attributes_window_name_container.add_element(self.attributes_window_name_const)
        self.attributes_window_name_var = ETKEdit(self._tk_object, text="-", size=Vector2d(200, self.ATTRIBUTES_ELEMENT_HEIGHT))
        ...
        self.attributes_window_title_const = ETKLabel(self._tk_object, text="Titel: ", size=Vector2d(45, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_window.background_color)
        self.attributes_window_title_container.add_element(self.attributes_window_title_const)
        self.attributes_window_title_var = ETKEdit(self._tk_object, text="-", size=Vector2d(200, self.ATTRIBUTES_ELEMENT_HEIGHT))
        ...
        self.attributes_window_size_const = ETKLabel(self._tk_object, text="Size: ", size=Vector2d(45, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_window.background_color)
        self.attributes_window_size_container.add_element(self.attributes_window_size_const)
        self.attributes_window_size_var_x = ETKEdit(self._tk_object, text="-", size=Vector2d(70, self.ATTRIBUTES_ELEMENT_HEIGHT))
        self.attributes_window_size_container.add_element(self.attributes_window_size_var_x)
        self.attributes_window_size_var_y = ETKEdit(self._tk_object, text="-", size=Vector2d(70, self.ATTRIBUTES_ELEMENT_HEIGHT))
        ...
        self.attributes_window_title_color_const = ETKLabel(self._tk_object, text="Title-Color (RGB 24bit): ", size=Vector2d(195, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_window.background_color)
        self.attributes_window_title_color_container.add_element(self.attributes_window_title_color_const)
        self.attributes_window_title_color_var_r = ETKEdit(self._tk_object, text="-", size=Vector2d(50, self.ATTRIBUTES_ELEMENT_HEIGHT))
        self.attributes_window_title_color_container.add_element(self.attributes_window_title_color_var_r)
        self.attributes_window_title_color_var_g = ETKEdit(self._tk_object, text="-", size=Vector2d(50, self.ATTRIBUTES_ELEMENT_HEIGHT))
        self.attributes_window_title_color_container.add_element(self.attributes_window_title_color_var_g)
        self.attributes_window_title_color_var_b = ETKEdit(self._tk_object, text="-", size=Vector2d(50, self.ATTRIBUTES_ELEMENT_HEIGHT))
        ...
        self.attributes_window_background_color_const = ETKLabel(self._tk_object, text="BG-Color (RGB 24bit): ", size=Vector2d(190, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_window.background_color)
        self.attributes_window_background_color_container.add_element(self.attributes_window_background_color_const)
        self.attributes_window_background_color_var_r = ETKEdit(self._tk_object, text="-", size=Vector2d(50, self.ATTRIBUTES_ELEMENT_HEIGHT))
        self.attributes_window_background_color_container.add_element(self.attributes_window_background_color_var_r)
        self.attributes_window_background_color_var_g = ETKEdit(self._tk_object, text="-", size=Vector2d(50, self.ATTRIBUTES_ELEMENT_HEIGHT))
        self.attributes_window_background_color_container.add_element(self.attributes_window_background_color_var_g)
        self.attributes_window_background_color_var_b = ETKEdit(self._tk_object, text="-", size=Vector2d(50, self.ATTRIBUTES_ELEMENT_HEIGHT))
        ...
        self.attributes_window_event_title = ETKLabel(self._tk_object, text="Events:", size=Vector2d(
            180, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_window.background_color)
        ...
        self.attributes_window_event_create_const = ETKLabel(self._tk_object, text="Event create: ", size=Vector2d(110, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_window.background_color)
        self.attributes_window_event_create_container.add_element(self.attributes_window_event_create_const)
        self.attributes_window_event_create_var = ETKCheckbox(self._tk_object, text="", size=Vector2d(17, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_window.background_color)
        ...
        self.attributes_window_event_destroy_const = ETKLabel(self._tk_object, text="Event destroy: ", size=Vector2d(115, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_window.background_color)
        self.attributes_window_event_destroy_container.add_element(self.attributes_window_event_destroy_const)
        self.attributes_window_event_destroy_var = ETKCheckbox(self._tk_object, text="", size=Vector2d(17, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_window.background_color)
        ...
        self.attributes_window_event_paint_const = ETKLabel(self._tk_object, text="Event paint: ", size=Vector2d(100, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_window.background_color)
        self.attributes_window_event_paint_container.add_element(self.attributes_window_event_paint_const)
        self.attributes_window_event_paint_var = ETKCheckbox(self._tk_object, text="", size=Vector2d(17, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_window.background_color)
        ...
        self.attributes_window_event_resize_const = ETKLabel(self._tk_object, text="Event resize: ", size=Vector2d(110, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_window.background_color)
        self.attributes_window_event_resize_container.add_element(self.attributes_window_event_resize_const)
        self.attributes_window_event_resize_var = ETKCheckbox(self._tk_object, text="", size=Vector2d(17, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_window.background_color)
        ...
        self.attributes_window_event_mouse_click_const = ETKLabel(self._tk_object, text="Event mouse_click: ", size=Vector2d(147, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_window.background_color)
        self.attributes_window_event_mouse_click_container.add_element(self.attributes_window_event_mouse_click_const)
        self.attributes_window_event_mouse_click_var = ETKCheckbox(self._tk_object, text="", size=Vector2d(17, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_window.background_color)
        ...
        self.attributes_window_event_mouse_move_const = ETKLabel(self._tk_object, text="Event mouse_move: ", size=Vector2d(140, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_window.background_color)
        self.attributes_window_event_mouse_move_container.add_element(self.attributes_window_event_mouse_move_const)
        self.attributes_window_event_mouse_move_var = ETKCheckbox(self._tk_object, text="", size=Vector2d(17, self.ATTRIBUTES_ELEMENT_HEIGHT), background_color=self.attributes_window.background_color)
