...
class IWindow(IBaseObject):
    ...
    def __init__(self, id: int, name: Optional[str] = None, title: str = "Window-Title", size: tuple[int, int] = (500, 500), title_color: tuple[int, int, int] = (0x00, 0x00, 0x00), background_color: tuple[int, int, int] = (0xAA, 0xAA, 0xAA), event_create: bool = True, event_destroy: bool = False, event_paint: bool = False, event_resize: bool = False, event_mouse_click: bool = False, event_mouse_move: bool = False, **kwargs: Any) -> None:     
        if name is None:
            name = f"window"
